...
<html>
  ...
  <nav id="main-nav" class="flex items-center justify-around p-4 gap-4 bg-gray-800">
    ...
    gap: 20px;
">
        <a href ="#" class="text-gray-300 hover:text-white transition-colors duration-300">Sign in</a>
        <a href ="#" class="text-gray-300 hover:text-white transition-colors duration-300">Sign up</a>
    </div>
</nav>
